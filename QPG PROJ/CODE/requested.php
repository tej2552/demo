        ...
        <div class="card-body">
            ...
            <div class="table-responsive " style="display:block;">
                <table class="table table-bordered">
                    ...
                    <tbody>
                       <?php $i=1;
					   $sql = "SELECT * from subject_request where staff_id='".$_SESSION['user_id']."' ";
                        ...
                        <tr>
                            ...
                            <td>  <?php if($row['status']=='Pending') { ?> <span class="badge badge-warning"><?php echo $row['status'];?></span><?php } elseif($row['status']=='Added') { ?> <span class="badge badge-success">Subject <?php echo $row['status'];?></span>
