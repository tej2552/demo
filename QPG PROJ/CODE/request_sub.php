...
$sql="insert into  subject_request(subject_name,staff_id,status)values('".$_POST['name']."','".$_SESSION['user_id']."','Pending')";
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="margin-top:100px;">
    <div class="card">
        <h5 class="card-header">Request Subject </h5>
        <div class="card-body">
	...
	<div class="form-group"> 
		<div class="col-sm-offset-2 col-sm-10">
			<input type="submit" class="btn btn-primary" value="REQUEST SUBJECT" name="add">
		</div>
	</div>
            </form>
        </div>
